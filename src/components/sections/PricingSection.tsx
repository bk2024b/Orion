      ...
      <div className="mx-auto w-[calc(100%-40px)] max-w-content">
        ...
        <div className="grid grid-cols-1 gap-3.5 md:grid-cols-3">
          ...
          <Reveal delay={0} className="h-full">
            <article className="flex h-full min-h-[520px] flex-col rounded-2xl border border-line bg-surface p-8 transition-all hover:-translate-y-1.5 hover:border-[#444]">
          ...
          <Reveal delay={0.08} className="h-full">
            <article className="relative flex h-full min-h-[520px] flex-col rounded-2xl border border-[#718f35] bg-surface p-8 shadow-[inset_0_1px_0_#9ac43b] transition-all hover:-translate-y-1.5 md:min-h-[555px]">
          ...
          <div className="mt-4 rounded-2xl border border-line bg-[#080808] p-6 md:p-10">
            ...
            <div className="mt-7 grid grid-cols-1 gap-px border border-line bg-line md:grid-cols-3">
              {[essential, growth, scale].map((plan, idx) => (
                <div key={idx} className="h-full bg-surface p-6">
