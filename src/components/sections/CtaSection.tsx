      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="p-10 sm:p-16 rounded-3xl bg-gradient-to-br from-obsidian-card to-obsidian-surface border border-violet-electric/40 shadow-violet-lg text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-violet-electric hover:bg-violet-hover text-white text-base font-semibold transition-all shadow-violet hover:scale-105"
            >
