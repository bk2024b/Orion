          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Link href="/services#web">01. {tDiv("web.name")}</Link>
              </li>
              <li className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Link href="/services#business">02. {tDiv("business.name")}</Link>
              </li>
              <li className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Link href="/services#systems">03. {tDiv("systems.name")}</Link>
              </li>
              <li className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Link href="/services#ai">04. {tDiv("ai.name")}</Link>
              </li>
            </ul>
          </div>
        </div>
